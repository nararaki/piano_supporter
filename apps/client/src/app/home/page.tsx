...
import { Heart, MessageCircle, Share, Plus, Home, User, Play, MoreHorizontal } from "lucide-react"
          ...
          <CardContent className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-6">
                ...
                <Button variant="ghost" size="sm" className="gap-2 hover:text-green-500 transition-colors">
            ...
            {myPosts.length > 0 ? (
              ...
              <Card className="text-center py-12">
                <CardContent>
                  ...
                  <Button onClick={() => setActiveTab("create")}>最初の投稿を作成</Button>
                </CardContent>
              </Card>
            )}
          </TabsContent>
